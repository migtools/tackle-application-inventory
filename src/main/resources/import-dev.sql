...
INSERT INTO stakeholder (id, displayName, email, jobFunction_id, createUser, createTime, deleted) VALUES (nextval('hibernate_sequence'), 'Jessica Fletcher', 'jbfletcher@murdershewrote.com', 30, 'mrizzi', CURRENT_TIMESTAMP, false);
INSERT INTO stakeholder (id, displayName, email, jobFunction_id, createUser, createTime, deleted) VALUES (nextval('hibernate_sequence'), 'Emmett Brown', 'doc@greatscott.movie', 31, 'mrizzi', CURRENT_TIMESTAMP, false);
INSERT INTO business_service (id, name, description, owner_id, createUser, createTime, deleted) VALUES (nextval('hibernate_sequence'), 'Home Banking BU', 'Important service to let private customer use their home banking accounts', 32, 'mrizzi', CURRENT_TIMESTAMP, false);
INSERT INTO business_service (id, name, description, owner_id, createUser, createTime, deleted) VALUES (nextval('hibernate_sequence'), 'Online Investments service', 'Corporate customers investments management', 33, 'foo', CURRENT_TIMESTAMP, false);
...
INSERT INTO tag (id, name, tagType_id, createUser, createTime, updateUser, updateTime, deleted) VALUES (nextval('hibernate_sequence'), 'EAP', 47, '<shipped-data>', CURRENT_TIMESTAMP, '<shipped-data>', CURRENT_TIMESTAMP, false);
INSERT INTO tag (id, name, tagType_id, createUser, createTime, updateUser, updateTime, deleted) VALUES (nextval('hibernate_sequence'), 'JWS', 47, '<shipped-data>', CURRENT_TIMESTAMP, '<shipped-data>', CURRENT_TIMESTAMP, false);
INSERT INTO tag (id, name, tagType_id, createUser, createTime, updateUser, updateTime, deleted) VALUES (nextval('hibernate_sequence'), 'Quarkus', 47, '<shipped-data>', CURRENT_TIMESTAMP, '<shipped-data>', CURRENT_TIMESTAMP, false);
INSERT INTO tag (id, name, tagType_id, createUser, createTime, updateUser, updateTime, deleted) VALUES (nextval('hibernate_sequence'), 'Spring Boot', 47, '<shipped-data>', CURRENT_TIMESTAMP, '<shipped-data>', CURRENT_TIMESTAMP, false);
INSERT INTO tag (id, name, tagType_id, createUser, createTime, updateUser, updateTime, deleted) VALUES (nextval('hibernate_sequence'), 'RHEL 8', 48, '<shipped-data>', CURRENT_TIMESTAMP, '<shipped-data>', CURRENT_TIMESTAMP, false);
INSERT INTO tag (id, name, tagType_id, createUser, createTime, updateUser, updateTime, deleted) VALUES (nextval('hibernate_sequence'), 'Windows Server 2016', 48, '<shipped-data>', CURRENT_TIMESTAMP, '<shipped-data>', CURRENT_TIMESTAMP, false);
...
INSERT INTO stakeholdergroup_stakeholders (group_id, stakeholder_id) VALUES (56, 33);
INSERT INTO stakeholdergroup_stakeholders (group_id, stakeholder_id) VALUES (57, 32);

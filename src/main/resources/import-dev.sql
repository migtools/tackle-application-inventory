...
INSERT INTO review (id, businesscriticality, comments, effortestimate, proposedaction, workpriority, application_id, deleted) VALUES (nextval('hibernate_sequence'), 1, 'first comment', 'Extra Large', 'Rehost', 2, 7, false);
INSERT INTO review (id, businesscriticality, comments, effortestimate, proposedaction, workpriority, application_id, deleted) VALUES (nextval('hibernate_sequence'), 1, 'other comment', 'Extra Large', 'Replatform', 8, 8, false);
INSERT INTO review (id, businesscriticality, comments, effortestimate, proposedaction, workpriority, application_id, deleted) VALUES (nextval('hibernate_sequence'), 1, 'another comment', 'Extra Large', 'Refactor', 9, 9, false);
